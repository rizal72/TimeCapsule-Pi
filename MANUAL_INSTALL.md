...
[global]
    ...
    # Security is handled by user authentication (valid users, security = user).
...
- [ ] Configure Tailscale for remote access (see [README.md](README.md#tailscale-remote-access))
